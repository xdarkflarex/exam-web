...
import { 
  ...
  Image, List, ListOrdered, Code, Quote
} from 'lucide-react'
...
export default function NewPostPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Đã lưu bài viết!' })
      setTimeout(() => router.push('/admin/posts'), 1000)
    } catch (err: any) {
      console.error('Save error:', err)
      setMessage({ type: 'error', text: err?.message || 'Lỗi khi lưu bài viết' })
    } finally {
      setSaving(false)
    }
  }
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-slate-800 dark:text-slate-100">Tạo bài viết mới</h1>
          </div>
