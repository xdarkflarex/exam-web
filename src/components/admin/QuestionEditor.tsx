...
export default function QuestionEditor({ 
  ...
  if (!formData) {
    return (
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 p-8 h-full flex items-center justify-center">
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 p-6">
      {/* Header */}
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Đang chỉnh sửa bảng <code className="bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded text-teal-600">questions</code>
          </p>
        </div>
        {hasChanges && (
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent resize-none text-slate-800 dark:text-slate-100"
            ...
            {options.map(({ key, field }) => (
              ...
              >
                ...
                <input
                  ...
                  className="flex-1 px-3 py-2 border-0 bg-transparent focus:outline-none focus:ring-0 text-slate-800 dark:text-slate-100"
      ...
      <div className="flex items-center gap-3 mt-8 pt-6 border-t border-slate-100">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
